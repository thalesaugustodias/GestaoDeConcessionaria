...
{
    public class AtualizarConcessionariaComandoValidador : AbstractValidator<AtualizarConcessionariaComando>
    {
        public AtualizarConcessionariaComandoValidador()
        {
            ...
            RuleFor(x => x.Dto)
                .NotNull()
                .WithMessage("Os dados da concessionária para atualização são obrigatórios.");
